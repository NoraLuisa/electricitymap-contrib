...
parser = argparse.ArgumentParser(description="Updating the data of a certain zone")
parser.add_argument("-zf", "--zonesfile", default=ZONESFILE)
parser.add_argument("-t", "--api-token", metavar = "", help="Security token of the ENTSOE API")
parser.add_argument("-z", "--zone", metavar = "", required = True, help="The zone abbreviation (e.g. AT)")
parser.add_argument("-df", "--data_file", nargs="?", metavar = "", required = True, help="The csv file from ENTSOE containing the installed capacities")
...
if __name__ == "__main__":
    main(args.zonesfile, args.api_token, args.zone, args.data_file)